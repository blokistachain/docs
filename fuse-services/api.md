...
The Blokista Studio REST API for accessing the data and the services of the Blokista network in a simple way. You can use this API to query and interact with the objects of the Blokista network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Blokista network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Blokista\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Blokista network |
...
| homeBridgeAddress | `String` | Bridge address on the Blokista network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Blokista network |
...
Community is a set of contracts and services. Members of the community are users of the Blokista network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Blokista network |
| homeTokenAddress | `String` | Address of the community token on the Blokista network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Blokista network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Blokista network |
...
Entity is an account on the Blokista network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Blokista network |
...
Tokens are compatible with the BCC20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
