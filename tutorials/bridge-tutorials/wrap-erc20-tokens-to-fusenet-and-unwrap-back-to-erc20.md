---
description: >-
  Steps to transfer/wrap BCC20 tokens from Ethereum to Fusenet and back using
  smart contracts.
---

# Using the bridge with BCC20 tokens directly through the contract

**Please use this tutorial at your own risk as it involves using Etherscan UI/Blokista explorer to relay the tokens. This tutorial is applicable only for BCC20 tokens other than BCC. Do not use this tutorial to transfer BCC.** 
