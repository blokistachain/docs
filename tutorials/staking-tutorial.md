---
description: This tutorial will explain how to delegate/stake/unstake your BCC.
---

# Staking tutorial

Note: You can only stake BCC which is on Blokista network. Please make sure you have changed into Blokista network in Metamask while doing any transactions on staking UI. 

How to Stake Blokista:

**Step 1:**

Navigate to staking.bccscan.com and login to your wallet through metamask. Make sure you are on Blokista network. If you are not please follow the instructions [**here**](https://docs.bccscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of BCC you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
